<template>
  <div class="mb-100px">
    ...
    <ol class="list-decimal flex flex-col gap-2">
      <li>
        If you subscribe to the Service and have not actively and explicitly canceled the Service 3 days before the expiry date, the relevant entity will automatically deduct the service fee for the next subscription period from the balance in your top-up account, bank card account, third party payment account such as Alipay, PayPal and other accounts (hereinafter referred to as the "Account") that you have bound when you open the Service on the expiry date of each subscription period and after the expiry date, thereby extending the validity of the Service corresponding to that subscription period. You accept and agree that you shall periodically pay attention to the Accounts corresponding to the selected payment method and guarantee that there is sufficient balance in the Accounts for you to use the Service. In the case that the Service is not available for the above-mentioned reasons (including but not limited to insufficient balance, balance insufficient for you to choose multiple Services), any resulting risk and/or loss will be at your own risk.
      </li>
      <li>
