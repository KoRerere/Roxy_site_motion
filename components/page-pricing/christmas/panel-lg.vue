...
defineProps<{
  showIllustrate: (e: any) => void
  hideIllustrate: (e: any) => void
    ...
    <div class="flex col-span-2 h-125px items-center justify-center">
      <div class="flex flex-col gap-2.5 items-center md:flex-row">
        <div class="flex gap-2.5 items-center justify-center">
          <div class="text-4.5 text-primary leading-26px font-[Archivo] font-600 inline-flex gap-1 cursor-pointer items-center" @mouseenter="showDropdown" @mouseleave="hideDropdown" @click="showDropdown">
            {{ $t('详细折扣信息') }}
        ...
        <div class="flex gap-2.5 items-center justify-center">
          ...
          <span class="flex flex-col gap-1">
            <span class="font-sub-title multilingual-text">
              /{{ $t('月') }}
              <span @click="showIllustrate" @mouseenter="showIllustrate" @mouseleave="hideIllustrate">
