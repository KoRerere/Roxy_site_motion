...
<template>
  <div class="px-3 py-4 border-1 border-[#C7CDD1] rounded-2 border-solid inline-flex gap-2 items-center">
    <span class="flex cursor-pointer items-center justify-center" @click="decrease">
    ...
    <input
      ...
      @input="handleInput"
    >
    <span class="flex cursor-pointer items-center justify-center" @click="increase">
