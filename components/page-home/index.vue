<template>
  <main>
            ...
            <div class="flex justify-center mt-5 md:mt-0">
              <div class="flex flex-col md:flex-row gap-y-5 gap-x-3 justify-center">
                ...
                <LiveChat class="flex justify-center">
                  <button
                    class="flex gap-2 items-center py-3 px-6 rounded-2 bg-white/10 text-white font-500 border-none cursor-pointer text-4">
          ...
          <div class="relative z-1">
            ...
            <p class="leading-[1.4] text-white/60 pt-20 pb-10 lg:pt-160px lg:pb-130px w-full md:w-60%">
              ...
              >
                <template #docs>
                  <a 
                    class="text-[#11A3FD] text-decoration-underline" 
                    :href="apiDocs" 
                    target="_blank"
                  >
                    {{ $t('API 文档') }}
            ...
            <PanelDownload class="mb-15" key="2">
              RoxyBrowser
            </PanelDownload>
          </div>
        </Container>
    ...
    <div class="bg-[#F3F4F7]" ref="usingAndInteractionRef">
      <Using />
      <Interaction />
    </div>
    ...
    <Tech />
    <div 
      class="bg-[radial-gradient(100%_100%_at_50%_0%,_#E8EFF2_0%,_#FFF_100%)]" 
      ref="communityRef"
    >
      <RxLazy tag="section" class="min-h-500px" :syncCompImport="() => import('./community.vue')" />
      <Faq :fqaList="fqaList" />
      <Container>
        <PanelDownload2 />
      </Container>
